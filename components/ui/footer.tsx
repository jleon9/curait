...
import logo from '@/public/images/Curait-logos-white.png';
      ...
      <div className="py-12 md:py-16">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <Link href="/" className="absolute content-start w-24 block mr-24">
              <img src={logo.src} />
            </Link>
              {/* Site branding */}
          <div className="shrink-0 mr-4 pb-20 pr-20">
            {/* Logo */}
